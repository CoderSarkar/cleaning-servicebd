...
import pic1 from "../../image/blog-1.jpeg";
                ...
                <div className="row mt-5">
                    ...
                    <div className="col-md-4 col-sm-4">
                        <div className="serviceContent text-center">
                            ...
                            <p> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Numquam perferendis eaque, obcaecati culpa aut maxime. </p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 col-sm-4">
                        <div className="serviceContent text-center">
                            ...
                            <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem sit, nostrum voluptatibus ea perferendis atque. </p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 col-sm-4">
                        <div className="serviceContent text-center">
                            ...
                            <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur quae doloribus aliquam amet impedit temporibus. </p>
                        </div>
                    </div>
