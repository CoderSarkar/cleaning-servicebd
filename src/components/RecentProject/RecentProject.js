    ...
    return (
        <section className="pt-5 mb-5">
            <div className="container">
                ...
                <h1 className="testimonialHeading mb-5">Our Recent Work </h1>
                <div className="row">

                    <div className="col-md-4 col-sm-4">
                        <div className=" text-center">
                            <img className="mb-5 img" src={pic1} alt="" />
                        </div>
                    </div>

                    <div className="col-md-4 col-sm-4">
                        <div className=" text-center">
                            <img className="mb-5 img" src={pic2} alt="" />
                        </div>
                    </div>

                    <div className="col-md-4 col-sm-4">
                        <div className=" text-center">
                            <img className="mb-5 img" src={pic3} alt="" />
                        </div>
                    </div>
